...
typedef struct {
    ...
    long long wl_canon_enum_successes;
    long long wl_canon_failures;
    long long wl_canon_refine_iterations;
    long long wl_canon_refine_popcounts;
    long long wl_canon_final_colour_sum;
    long long wl_canon_final_largest_cell_sum;
    long long wl_canon_final_largest_cell_max;
    long long wl_canon_enum_attempts;
    long long wl_canon_enum_permutations;
