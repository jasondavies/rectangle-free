...
PARTITION_CFLAGS ?= -O3 -march=native $(OPENMP_CFLAGS) $(OPENSSL_CFLAGS) -DUSE_TLS -I$(NAUTY_BUILD_DIR) -I$(NAUTY_DIR)
LDFLAGS ?= $(NAUTY_BUILD_DIR)/nautyT.a -lm $(OPENMP_LDFLAGS) $(OPENSSL_LDFLAGS)
